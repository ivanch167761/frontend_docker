    ...
    <>
      {
        categories.loading
          ...
          : categories.error
            ...
            : (
              <section className='pt-16 lg:pt-[120px] pb-10 lg:pb-20 bg-[#F3F4F6]'>
                <div className='container mx-auto grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4'>
